...
The next announcment was that Microsoft have [managed to](https://blogs.microsoft.com/blog/2023/06/21/accelerating-scientific-discovery-with-azure-quantum/) create topological qubits, exotic quasi-particles with characteristics that make them inherently noise-tolerant. This is very exciting seeing as the idea of a topological quantum computer has been around since 1997. It is still early days for the technology and topological qubits are not a part of any quantum computer offered by vendors.
