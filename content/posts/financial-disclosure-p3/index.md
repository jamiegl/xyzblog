...
*I want to give a lot of credit to [this article]("https://pyimagesearch.com/2022/02/28/multi-column-table-ocr/") from pyimagesearch for giving me alot of inspiration on how to tackle the problems presented in the blog. It's a fantastic site worth checking out if you are thinking of getting into computer vision*
...
[(4, '11'),
 ...
 Which is *almost* right - you can see "None" is put in the middle of a different cluster to the one it is associated with. This is because that cluster is defined by vertical associations as apposed to horizontal ones, which is how tesseract orders thing. We'll fix this in the next article.
